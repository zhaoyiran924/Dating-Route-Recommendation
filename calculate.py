#This is the process calculate final route and activities for dating 
...
#Build a new thread to show two parellel images
...
#This class use floyd algorithm to calculate shortest path
class floyd():
